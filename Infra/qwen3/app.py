...
def _generate(text: str, voice_description: str, language: str = "auto") -> bytes:
...
async def synthesize(
    ...
    async with _gen_lock:
        wav_bytes = await _run_with_cancel(request, lambda: _generate(text, voice_description, language))
