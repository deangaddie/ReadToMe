...
| Audio pipeline | [context/audio-pipeline.md](context/audio-pipeline.md) | Normalisation, Canonical reference WAV, Audio Queue, Audio Gen Stream, Audio Retry, pipeline/resolver/recorder seams, outcomes, Sentence Chunking |
