...
namespace Read2Me.AppData.Migrations
{
    ...
    [Migration("20260622124849_AddPauseDurationSettings")]
    partial class AddPauseDurationSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Read2Me.AppData.Entities.AppSettings", b =>
                {
                    ...
                    b.Property<int>("SentenceMinChunkChars")
                        .HasColumnType("INTEGER");

                    b.Property<int>("SentencePauseMs")
                        .HasColumnType("INTEGER");
