...
{
    public static class ChatterboxTurboParagraphTtsSettingsDiff
    {
        private static readonly JsonSerializerOptions WebOptions =
            new(JsonSerializerDefaults.Web);

        public static string Diff(string baseJson, ChatterboxTurboParagraphTtsSettings edited)
        {
        ...
        public static ChatterboxTurboParagraphTtsSettings Apply(string baseJson, string? patchJson)
            => VoiceDesignSettingsMerge.Merge<ChatterboxTurboParagraphTtsSettings>(baseJson, patchJson);
    }
}
