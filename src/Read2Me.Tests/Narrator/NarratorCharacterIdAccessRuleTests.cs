...
namespace Read2Me.Tests.Narrator
{
    ...
    public class NarratorCharacterIdAccessRuleTests
    {
        ...
        private static readonly Dictionary<string, string> Allowed = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            [@"Read2Me.Services\Mutations\Implementations\CharacterLifecycleMutationImplementations.cs"] =
                "the sanctioned writers — the link itself, plus delete clearing it and merge repointing it",
            [@"Read2Me.Tests\Services\Mutations\CharacterLifecycleMutationTests.cs"] =
                "asserts delete cleared the column, not the fallback",
